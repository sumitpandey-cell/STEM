...
export default function StudentLoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-background to-[#fff2d6] overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <Rocket className="absolute top-[20%] left-[15%] w-24 h-24 text-gray-300/70 animate-float-1" />
        <AtomIcon className="absolute bottom-[25%] right-[10%] w-28 h-28 text-gray-300/70 animate-float-2" />
        <Puzzle className="absolute top-[50%] right-[25%] w-20 h-20 text-gray-300/70 animate-float-3" />
      </div>
      <Card className="w-full max-w-sm mx-4 p-2 bg-white/80 backdrop-blur-sm border-gray-200/50 shadow-2xl animate-in fade-in-0 slide-in-from-bottom-12 duration-1000">
